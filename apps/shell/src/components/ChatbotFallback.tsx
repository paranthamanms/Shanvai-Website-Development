...
export function ChatbotFallback({
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[100] max-w-[calc(100vw-2rem)] font-body text-sm sm:bottom-5 sm:right-5">
      <AnimatePresence>
        {open && (
          <motion.section
            key="panel"
            ...
            className="mb-3 flex h-[min(560px,70vh)] w-full max-w-[380px] flex-col overflow-hidden rounded-2xl border border-line bg-surface shadow-soft"
          >
